...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form method="POST" action="<?php echo e(route('products.store')); ?>" x-data="productForm()" class="track-changes">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="kode_barang" value="<?php echo e(old('kode_barang')); ?>" required
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="nama_barang" value="<?php echo e(old('nama_barang')); ?>" required
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div>
                    ...
                    <select name="category_id" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($cat->id); ?>" <?php echo e(old('category_id') == $cat->id ? 'selected' : ''); ?>><?php echo e($cat->nama); ?></option>
                ...
                <div>
                    ...
                    <select name="satuan" required class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500">
                        ...
                        <option value="sachet" <?php echo e(old('satuan') == 'sachet' ? 'selected' : ''); ?>>Sachet</option>
                ...
                <div>
                    ...
                    <input type="text" name="pabrik" value="<?php echo e(old('pabrik')); ?>"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div>
                    ...
                    <select name="grup" required class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500">
                        <option value="hijau" <?php echo e(old('grup') == 'hijau' ? 'selected' : ''); ?>>🟢 Hijau - Obat Bebas</option>
                        <option value="merah" <?php echo e(old('grup') == 'merah' ? 'selected' : ''); ?>>🔴 Merah - Obat Keras / Narkotika</option>
                        <option value="biru" <?php echo e(old('grup') == 'biru' ? 'selected' : ''); ?>>🔵 Biru - Konsinyasi</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="kelas_terapi" value="<?php echo e(old('kelas_terapi')); ?>"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div>
                    ...
                    <input type="text" name="lokasi_rak" value="<?php echo e(old('lokasi_rak')); ?>"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div>
                    ...
                    <input type="text" name="stok" value="<?php echo e(old('stok', 0)); ?>" inputmode="numeric" required
                ...
                <div>
                    ...
                    <input type="text" name="stok_minimum" value="<?php echo e(old('stok_minimum', 5)); ?>" inputmode="numeric" required
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 money-format">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="keterangan" rows="3" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('keterangan')); ?></textarea>
                </div>
            </div>
...
function productForm() {
    return {
        hna: <?php echo e(old('harga_beli', 0)); ?>,
        hargaJual: 0,
        hargaHV: 0,
        hargaResep: 0,
        init() {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\WORK\other\kasir_test\resources\views/products/create.blade.php ENDPATH**/ ?>