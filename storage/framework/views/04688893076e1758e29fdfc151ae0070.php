...
<?php $__env->startSection('page-title', 'Edit Barang: ' . $product->nama_barang); ?>

<?php $__env->startSection('breadcrumb'); ?>
<li><span class="mx-1">/</span></li>
<li><a href="<?php echo e(route('products.index')); ?>" class="hover:text-gray-700">Data Barang</a></li>
<li><span class="mx-1">/</span></li>
<li class="text-gray-800 font-medium">Edit: <?php echo e($product->nama_barang); ?></li>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form method="POST" action="<?php echo e(route('products.update', $product)); ?>" x-data="productForm()" class="track-changes">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="kode_barang" value="<?php echo e(old('kode_barang', $product->kode_barang)); ?>" required
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="nama_barang" value="<?php echo e(old('nama_barang', $product->nama_barang)); ?>" required
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div>
                    ...
                    <select name="category_id" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($cat->id); ?>" <?php echo e(old('category_id', $product->category_id) == $cat->id ? 'selected' : ''); ?>><?php echo e($cat->nama); ?></option>
                ...
                <div>
                    ...
                    <select name="satuan" required class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500">
                        <?php $__currentLoopData = ['pcs','strip','box','botol','tube','sachet','tablet','kapsul']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($s); ?>" <?php echo e(old('satuan', $product->satuan) == $s ? 'selected' : ''); ?>><?php echo e(ucfirst($s)); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="pabrik" value="<?php echo e(old('pabrik', $product->pabrik)); ?>"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div>
                    ...
                    <select name="grup" required class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500">
                        <option value="hijau" <?php echo e(old('grup', $product->grup) == 'hijau' ? 'selected' : ''); ?>>🟢 Hijau - Obat Bebas</option>
                        <option value="merah" <?php echo e(old('grup', $product->grup) == 'merah' ? 'selected' : ''); ?>>🔴 Merah - Obat Keras</option>
                        <option value="biru" <?php echo e(old('grup', $product->grup) == 'biru' ? 'selected' : ''); ?>>🔵 Biru - Konsinyasi</option>
                    </select>
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Kelas Terapi</label>
                    <input type="text" name="kelas_terapi" value="<?php echo e(old('kelas_terapi', $product->kelas_terapi)); ?>"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Lokasi Rak</label>
                    <input type="text" name="lokasi_rak" value="<?php echo e(old('lokasi_rak', $product->lokasi_rak)); ?>"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="stok_minimum" value="<?php echo e(old('stok_minimum', $product->stok_minimum)); ?>" inputmode="numeric" required
                ...
                <div>
                    ...
                    <input type="date" name="expired_date" value="<?php echo e(old('expired_date', $product->expired_date?->format('Y-m-d'))); ?>"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="keterangan" rows="3" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('keterangan', $product->keterangan)); ?></textarea>
                </div>
            </div>

            <div class="flex items-center justify-end space-x-3 mt-6 pt-4 border-t border-gray-200">
                <a href="<?php echo e(route('products.index')); ?>" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 text-sm">Batal</a>
...
function productForm() {
    return {
        hna: <?php echo e(old('harga_beli', $product->harga_beli)); ?>,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\WORK\other\kasir_test\resources\views/products/edit.blade.php ENDPATH**/ ?>