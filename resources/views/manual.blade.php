...
<body class="bg-white text-gray-800 max-w-4xl mx-auto p-8">
    ...
    <div class="no-print fixed top-4 right-4 flex gap-2 z-50">
        ...
        <a href="{{ route('dashboard') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg text-sm hover:bg-gray-300 shadow">
    ...
    <div class="text-center py-16 border-b-4 border-indigo-600 mb-8">
        ...
        <p class="text-sm text-gray-400 mt-4">Versi 2.0 — {{ now()->format('F Y') }}</p>
    </div>
    ...
    <div class="mb-8">
        ...
        <ol class="space-y-1 text-sm">
            <li class="flex justify-between"><span>1. Login & Keamanan</span></li>
            <li class="flex justify-between"><span>2. Dashboard</span></li>
            <li class="flex justify-between"><span>3. Manajemen Barang / Obat</span></li>
            <li class="flex justify-between"><span>4. Supplier (PBF)</span></li>
            <li class="flex justify-between"><span>5. Pembelian</span></li>
            <li class="flex justify-between"><span>6. Kasir / POS</span></li>
            <li class="flex justify-between"><span>7. Penjualan Resep</span></li>
            <li class="flex justify-between"><span>8. Laporan</span></li>
            <li class="flex justify-between"><span>9. Closing Kasir</span></li>
            <li class="flex justify-between"><span>10. Pengaturan Harga</span></li>
            <li class="flex justify-between"><span>11. Audit Log</span></li>
            <li class="flex justify-between"><span>12. Tema & Tampilan</span></li>
            <li class="flex justify-between"><span>13. Keyboard Shortcuts</span></li>
        </ol>
    </div>

    <!-- BAB 1 -->
    <div class="page-break"></div>
    <h2 class="text-2xl font-bold text-indigo-700 mb-4">1. Login & Keamanan</h2>
    ...
    <h3 class="text-lg font-semibold mt-4 mb-2">Single Login</h3>
    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3 text-sm mb-4">
        <strong>⚠️ Penting:</strong> Sistem menerapkan <strong>single login</strong> — setiap akun hanya boleh login di 1 perangkat. 
        Jika login dari perangkat lain, sesi di perangkat sebelumnya akan otomatis berakhir dan tercatat di Audit Log.
    </div>

    <h3 class="text-lg font-semibold mt-4 mb-2">Hak Akses</h3>
    <ul class="list-disc list-inside text-sm space-y-1">
        <li><strong>Admin</strong> — Akses penuh: semua fitur + Manajemen User + Pengaturan + Audit Log</li>
        <li><strong>Apoteker</strong> — Semua fitur operasional (tanpa manajemen user & pengaturan)</li>
    ...
    <p class="mb-3">Halaman utama setelah login. Menampilkan ringkasan operasional:</p>
    <ul class="list-disc list-inside text-sm space-y-1 mb-4">
        ...
        <li><strong>Total Produk Aktif</strong> — Jumlah item obat tersedia</li>
    ...
    <h3 class="text-lg font-semibold mt-4 mb-2">Riwayat Harga</h3>
    <p class="text-sm mb-4">Setiap kali ada pembelian dengan harga HNA berbeda, perubahan harga otomatis tercatat. Lihat di halaman <strong>Detail Barang</strong> → bagian "Riwayat Perubahan Harga".</p>

    <!-- BAB 4 -->
    <div class="page-break"></div>
    <h2 class="text-2xl font-bold text-indigo-700 mb-4">4. Supplier (PBF)</h2>
    <p class="mb-3">Kelola data Pedagang Besar Farmasi (PBF).</p>
    <ol class="list-decimal list-inside text-sm space-y-1">
        ...
        <li><strong>Jatuh Tempo</strong> = batas waktu pembayaran faktur</li>
    </ol>
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-3 text-sm mb-4">
        <strong>Otomatis:</strong> Stok bertambah, harga diperbarui, kartu stok tercatat, riwayat harga tercatat (jika HNA berubah).
    </div>
    <h3 class="text-lg font-semibold mt-4 mb-2">Retur Pembelian</h3>
    <p class="text-sm">Buka detail pembelian → klik <strong>"Retur"</strong> → pilih item & qty yang diretur.</p>

    <!-- BAB 6 -->
    <div class="page-break"></div>
    <h2 class="text-2xl font-bold text-indigo-700 mb-4">6. Kasir / POS</h2>
    <ol class="list-decimal list-inside text-sm space-y-1 mb-4">
        <li><strong>Cari barang</strong> — ketik nama atau kode barang</li>
        <li><strong>Klik barang</strong> dari dropdown → masuk keranjang</li>
        <li>Atur <strong>qty</strong> dan <strong>diskon</strong> (pilih % atau Rp)</li>
    ...
    <ol class="list-decimal list-inside text-sm space-y-1 mb-4">
        ...
        <li>Harga otomatis mengunakan <strong>Harga Resep</strong></li>
    </ol>
    <div class="bg-purple-50 border border-purple-200 rounded-lg p-3 text-sm mb-4">
        <strong>Catatan:</strong> Struk resep <strong>tidak menampilkan daftar obat</strong> (rahasia medis). Hanya jumlah item dan total harga.
    </div>
    ...
    <p class="text-sm mb-4">Filter: tanggal, shift (pagi/siang), metode bayar. Menampilkan total, breakdown, detail per transaksi. Bisa di-print.</p>
    <h3 class="text-lg font-semibold mt-4 mb-2">Laporan Arus Kas</h3>
    <p class="text-sm mb-4">Semua aliran uang masuk (debit) dan keluar (kredit). Saldo = Debit - Kredit.</p>
    <h3 class="text-lg font-semibold mt-4 mb-2">Produk Terlaris</h3>
    <p class="text-sm mb-4">Ranking produk berdasarkan jumlah terjual.</p>
    ...
    <table class="w-full text-sm border border-gray-200 mb-4">
        ...
        <tbody>
            <tr><td class="p-2 border-b font-bold">1. Buka Shift</td><td class="p-2 border-b">Pilih shift (Pagi 07:00-13:59 / Siang 14:00-21:00) → input saldo awal</td></tr>
            <tr><td class="p-2 border-b font-bold">2. Transaksi</td><td class="p-2 border-b">Lakukan penjualan di POS</td></tr>
    ...
    <!-- BAB 10 -->
    <div class="page-break"></div>
    <h2 class="text-2xl font-bold text-indigo-700 mb-4">10. Pengaturan Harga (Admin)</h2>
    <p class="mb-3">Menu <strong>Pengaturan</strong> untuk mengatur persentase markup:</p>
    <table class="w-full text-sm border border-gray-200 mb-4">
        <thead class="bg-gray-50"><tr><th class="p-2 text-left border-b">Parameter</th><th class="p-2 text-left border-b">Default</th><th class="p-2 text-left border-b">Rumus</th></tr></thead>
        <tbody>
    ...
    <!-- BAB 11 -->
    <div class="page-break"></div>
    <h2 class="text-2xl font-bold text-indigo-700 mb-4">11. Audit Log (Admin)</h2>
    <p class="mb-3">Mencatat semua aktivitas penting di sistem:</p>
    <table class="w-full text-sm border border-gray-200 mb-4">
        <thead class="bg-gray-50"><tr><th class="p-2 text-left border-b">Aksi</th><th class="p-2 text-left border-b">Contoh</th></tr></thead>
        <tbody>
            <tr><td class="p-2 border-b">Login</td><td class="p-2 border-b">User login: Administrator (IP: 127.0.0.1)</td></tr>
            <tr><td class="p-2 border-b">Force Logout</td><td class="p-2 border-b">Multiple login terdeteksi: Admin login dari IP baru. Session lama di-terminate.</td></tr>
            <tr><td class="p-2 border-b">Create</td><td class="p-2 border-b">Tambah barang: Paracetamol 500mg (OBT-001)</td></tr>
            <tr><td class="p-2 border-b">Update</td><td class="p-2 border-b">Edit barang: Paracetamol 500mg</td></tr>
            <tr><td class="p-2 border-b">Delete</td><td class="p-2 border-b">Hapus barang: Paracetamol 500mg</td></tr>
            <tr><td class="p-2 border-b">Void</td><td class="p-2 border-b">Void nota INV-20260430-0001</td></tr>
        </tbody>
    </table>

    <!-- BAB 12 -->
    <div class="page-break"></div>
    <h2 class="text-2xl font-bold text-indigo-700 mb-4">12. Tema & Tampilan</h2>
    <h3 class="text-lg font-semibold mt-4 mb-2">Dark Mode</h3>
    <p class="text-sm mb-4">Klik ikon 🌙 di navbar untuk beralih ke mode gelap. Klik ikon 🎨 untuk membuka panel tema.</p>
    <h3 class="text-lg font-semibold mt-4 mb-2">Warna Aksen</h3>
    <p class="text-sm mb-2">6 pilihan warna aksen:</p>
    <table class="w-full text-sm border border-gray-200 mb-4">
        <tbody>
            <tr><td class="p-2 border-b">🟣 Indigo</td><td class="p-2 border-b">🔵 Biru</td><td class="p-2 border-b">🟢 Hijau</td></tr>
            <tr><td class="p-2 border-b">🔴 Merah</td><td class="p-2 border-b">🟡 Kuning</td><td class="p-2 border-b">🟣 Ungu</td></tr>
        </tbody>
    </table>
    <h3 class="text-lg font-semibold mt-4 mb-2">Format Angka</h3>
    <p class="text-sm mb-4">Semua input uang otomatis terformat ribuan (contoh: 1,000,000).</p>

    <!-- BAB 13 -->
    <div class="page-break"></div>
    <h2 class="text-2xl font-bold text-indigo-700 mb-4">13. Keyboard Shortcuts (POS)</h2>
    <table class="w-full text-sm border border-gray-200 mb-4">
        ...
        <tbody>
            ...
            <tr><td class="p-2 border-b font-mono">Esc</td><td class="p-2 border-b">Kosongkan pencarian / keranjang</td></tr>
        </tbody>
    </table>

    <h2 class="text-2xl font-bold text-indigo-700 mb-4">Tips Tambahan</h2>
    <ul class="list-disc list-inside text-sm space-y-2">
        <li><strong>Void Nota</strong> — Buka Daftar Penjualan → klik ikon 🚫 → konfirmasi. Stok otomatis dikembalikan.</li>
        <li><strong>Stock Opname</strong> — Menu Stock Opname → Buat baru → input stok fisik → Setujui untuk update stok.</li>
        <li><strong>Print Laporan</strong> — Klik "Print" di halaman laporan. Dark mode otomatis dinonaktifkan saat print.</li>
        <li><strong>Buku Manual</strong> — Akses via menu user (pojok kanan atas) → "Buku Manual".</li>
    </ul>

    <!-- Footer -->
    <div class="page-break"></div>
    <div class="text-center py-16 border-t-4 border-indigo-600 mt-8">
        <h2 class="text-2xl font-bold text-gray-900 mb-2">Apotek POS v2.0</h2>
